<main id="main" class="main">
  ...
  <div style="text-align: right;">
    <a href="<?= base_url('data/tambah_alternatif_rsm'); ?>" class="btn btn-primary"><i class="ri-add-fill"></i>
      Tambah data
    </a>
  </div>
  <br>
              ...
              <tbody>
                ...
                foreach ($alternatif_rsm as $dp) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?= base_url('data/edit_alternatif_rsm'); ?>/<?= $dp['id'] ?>"
                        class="btn btn-sm btn-outline-primary" data-bs-toggle="tooltip" data-bs-placement="left"
                        title="Edit"><i class="bi bi-pencil-square"></i></a>
                      <a href="<?= base_url('data/hapus_alternatif_rsm'); ?>/<?= $dp['id'] ?>"
