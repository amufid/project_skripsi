       ...
       <div class="pagetitle">
              ...
              <nav>
                     <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Perhitungan RSM</li>
                            ...
                            <div class="col-lg-12">
                                                        ...
                                                        <tbody>
                                                               ...
                                                               foreach ($alternatif_rsm as $rp):
                                                                      ...
                                                                      <tr>
                                                                             ...
                                                                             <td>
                                                                                    <a href="<?= base_url('data/edit_alternatif_rsm'); ?>/<?= $rp['id'] ?>"
                                   ...
                                   <div class="card">
                                          <div class="card-body">
                                                 <br>
                                                 <h5 class="text-white bg-primary">
                                                        Solusi ideal positif (A+) dan solusi ideal negatif (A-)</h5>
                                                 <table class="table table-bordered" style="text-align: center;">
                                                        <thead>
                                                               <tr>
                                                                      <th>Nilai</th>
