                     ...
                     <div class="col-lg-9">
                            <div class="card">
                                   <div class="card-body">
                                          ...
                                          <?php echo form_open_multipart('data/fungsi_tambah_alternatif_rsm'); ?>
                                          <form>
                                                 ...
                                                 <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-7">
                                                               <input type="text" class="form-control" name="kode"
                                                                      value="<?php echo kodeRsmOtomatis(); ?>" readonly>
                                                        </div>
                                                 </div>
                                                 <div class="row mb-3">
                                                 ...
                                                 <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-7">
                                                               ...
                                                               <!-- <input type="number" class="form-control" name="kap_penumpang" min="2" max="8" required=""> -->
                                                        </div>
                                                 </div>
                                                 ...
                                                 <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-7">
                                                               <select name="c2" type="text" class="form-select"
                                                                      ...
                                                                      <option selected></option>
                                                                      <option disabled>-Pilih-</option>
                                                                      <option value="2">7 penumpang</option>
                                                                      <option value="1">5 penumpang</option>
                                                               </select>
                                                        </div>
                                                 </div>
                                                 ...
                                                 <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-7">
                                                               <select name="c3" type="text" class="form-select"
                                                                      ...
                                                                      <option value="4">2012 - 2018</option>
                                                                      <option value="3">2006 - 2011</option>
                                                 ...
                                                 <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-7">
                                                               <select name="c4" type="text" class="form-select"
                                                                      ...
                                                                      <option selected></option>
                                                                      <option disabled>-Pilih-</option>
                                                                      <option value="5">> 180jt</option>
                                                                      <option value="4">130jt - 180jt</option>
                                                                      <option value="3">80jt - 129jt</option>
                                                                      <option value="2">30jt - 79jt</option>
                                                                      <option value="1">
                                                                             < 30jt</option>
                                                               </select>
                                                        </div>
                                                 ...
                                                 <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-7">
                                                               <select name="c6" type="text" class="form-select"
                                                                      ...
                                                                      <option value="4">6,1jt – 10jt</option>
                                                                      <option value="3">3,1jt – 6jt</option>
                                                                      <option value="2">1jt – 3jt</option>
                                                                      <option value="1">
                                                                             < 1jt</option>
                                                               </select>
                                                        </div>
