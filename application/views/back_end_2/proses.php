<main id="main" class="main">
       <div class="pagetitle">
              ...
              <nav>
                     <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Perhitungan RSM</li>
                     </ol>
              </nav>
       ...
       <body>
                                   ...
                                   <div class="card">
                                          <div class="card-body">
                                                 ...
                                                 <h5 class="fw-bold">Pilih
                                                        bobot</h5>
                                                 <?php echo form_open('perhitungan/updateData_rsm'); ?>
              ...
              <div class="row mb-2">
                     <div class="text-center col-sm-12">
                            <a href="<?= base_url('perhitungan/perhitungan_rsm') ?>" class="btn btn-success">Tampilkan
                                   semua
                                   hasil
                                   perhitungan!</a>
                     </diV>
