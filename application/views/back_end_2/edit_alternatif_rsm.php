                            ...
                            <div class="col-lg-9">
                                   <div class="card">
                                          <div class="card-body">
                                                 ...
                                                 <?php echo form_open_multipart('data/fungsi_edit_alternatif_rsm'); ?>
                                                 <form>
                                                        <input type="hidden" name="id"
                                                               value="<?php echo $alternatif_rsm['id']; ?>">
                                                        ...
                                                        <div class="row mb-3">
                                                               ...
                                                               <div class="col-sm-7">
                                                                      <input type="text" class="form-control"
                                                                             name="kode" required=""
                                                                             value="<?php echo $alternatif_rsm['kode']; ?>">
                                                               </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                               <label for="merk"
                                                        ...
                                                        <div class="row mb-3">
                                                               ...
                                                               <div class="col-sm-7">
                                                                      <input type="text" class="form-control"
                                                                             name="model" required=""
                                                                             value="<?php echo $alternatif_rsm['model']; ?>">
                                                               </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                               <label for="kap_mesin"
                                                               ...
                                                               <div class="col-sm-7">
                                                                      <input type="text" class="form-control"
                                                                             ...
                                                                             value="<?php echo $alternatif_rsm['kap_mesin']; ?>">
                                                               </div>
                                                        </div>
                                                        ...
                                                        <div class="row mb-3">
                                                               ...
                                                               <div class="col-sm-7">
                                                                      <select name="kap_penumpang" type="text"
                                                                             class="form-select" required="">
                                                                             <option selected>
                                                                                    <?php echo $alternatif_rsm['kap_penumpang']; ?>
                                                                             </option>
                                                        ...
                                                        <div class="row mb-3">
                                                               ...
                                                               <div class="col-sm-7">
                                                                      ...
                                                                      <input type="number" class="form-control"
                                                                             ...
                                                                             value="<?php echo $alternatif_rsm['th_pembuatan']; ?>">
                                                               </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                               <label for="harga"
                                                               ...
                                                               <div class="col-sm-7">
                                                                      <input type="text" class="form-control"
                                                                             name="harga" required=""
                                                                             value="<?php echo $alternatif_rsm['harga']; ?>">
                                                               </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                               <label for="transmisi"
                                                               ...
                                                               <div class="col-sm-7">
                                                                      <select name="transmisi" type="text"
                                                                             class="form-select" required="">
                                                                             <option selected>
                                                                                    <?php echo $alternatif_rsm['transmisi']; ?>
                                                                             </option>
                                                                             <option disabled>-Pilih-</option>
                                                                             <option>MT</option>
                                                                             <option>AT</option>
                                                        ...
                                                        <div class="row mb-3">
                                                               ...
                                                               <div class="col-sm-7">
                                                                      <input type="text" class="form-control"
                                                                             name="pajak" required=""
                                                                             value="<?php echo $alternatif_rsm['pajak']; ?>">
                                                               </div>
                                                        </div>
